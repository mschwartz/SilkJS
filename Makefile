OBJ=	main.o base64.o global.o console.o process.o net.o fs.o buffer.o mysql.o http.o gd.o ncurses.o sem.o logfile.o v8.o md5.o sqlite3.o
...
silkjs:	$(OBJ) SilkJS.h Makefile
	g++ $(CFLAGS) -o silkjs $(OBJ) -L../v8-read-only/out/x64.release/obj.target/tools/gyp/ -lv8_base -lv8_snapshot -L/usr/local/lib/mysql -lmysqlclient -lmm -lgd -lncurses -lssl -lpthread -lsqlite3
